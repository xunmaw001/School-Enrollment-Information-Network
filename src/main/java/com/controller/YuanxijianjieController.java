...
public class YuanxijianjieController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YuanxijianjieEntity yuanxijianjie, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YuanxijianjieEntity yuanxijianjie, HttpServletRequest request){
        EntityWrapper<YuanxijianjieEntity> ew = new EntityWrapper<YuanxijianjieEntity>();
    	PageUtils page = yuanxijianjieService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yuanxijianjie), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
