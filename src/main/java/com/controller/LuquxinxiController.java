...
public class LuquxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,LuquxinxiEntity luquxinxi, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,LuquxinxiEntity luquxinxi, HttpServletRequest request){
        EntityWrapper<LuquxinxiEntity> ew = new EntityWrapper<LuquxinxiEntity>();
    	PageUtils page = luquxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, luquxinxi), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
