                  ...
                  <div class="gallery-item isotope-item print-media col-lg-3 col-sm-3 col-xs-6" v-for="(item,index) in dataList" v-bind:key="index">
                    <div class="inner-contents">
                      <figure style="text-align: center;">
                        <a class="gallery-btn swipebox" :href="'../dangyuanfengcai/detail.jsp?id='+item.id">查看更多</a>
                        <div class="media-container"></div>
                        <a :href="'../dangyuanfengcai/detail.jsp?id='+item.id">
                          <img :src="item.touxiang?item.touxiang.split(',')[0]:''" width="210" height="150" />
                      </figure>
                      <h5 class="item-title"><a :href="'../dangyuanfengcai/detail.jsp?id='+item.id">{{item.jiaoshixingming}}</a></h5>
