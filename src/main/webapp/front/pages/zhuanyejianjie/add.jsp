		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<textarea name="zhuanyejianjie" id="zhuanyejianjie">请输入专业简介</textarea>
						</div>
					</div>
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                                                                                                    					                                                                                                                                                                					...
                                                                                                                                                                                    					                                                                                                                                                                					var zhuanyejianjie = tinymce.get('#zhuanyejianjie').getContent()
					data.zhuanyejianjie = zhuanyejianjie;
					...
					// 提交数据
					http.requestJson('zhuanyejianjie' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
