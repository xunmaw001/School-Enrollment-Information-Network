			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.yuanximingcheng" type="text" name="yuanximingcheng" id="yuanximingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<button type="button" class="layui-btn btn-theme" id="tupianUpload">
								<i class="layui-icon">&#xe67c;</i>上传图片
                                                                                                                                            ...
                                                                                                                                            <div class="layui-form-item" pane>
						<label class="layui-form-label">院系简介：</label>
						<div class="layui-input-block">
							<textarea name="yuanxijianjie" id="yuanxijianjie">请输入院系简介</textarea>
						</div>
					</div>
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                                                                                                    					                                                                                                                                                                					...
                                                                                                                                                                                    					                                                                                                                                                                					var yuanxijianjie = tinymce.get('#yuanxijianjie').getContent()
					data.yuanxijianjie = yuanxijianjie;
					...
					// 提交数据
					http.requestJson('yuanxijianjie' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
